...
(library Library_1
	...
	(patternDef "3025" (originalName "3025")
		...
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt 0.000, 0.198) (textStyleRef "Normal") (isVisible True))
		)
		...
		(layerContents (layerNumRef 28)
			(line (pt -3.785 -10.4) (pt -11.925 -3.9) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -11.925 -3.9) (pt -11.925 3.9) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -11.925 3.9) (pt -7.5 10.4) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -7.5 10.4) (pt -7.5 10.4) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(arc (pt -6.75, 9.8895) (radius 0.907) (startAngle 145.8) (sweepAngle -111.5) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -6 10.4) (pt -3.785 9.1) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -3.785 9.1) (pt -3.785 9.1) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(arc (pt 0, 15.549) (radius 7.478) (startAngle 239.6) (sweepAngle 60.8) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 3.785 9.1) (pt 6 10.4) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 6 10.4) (pt 6 10.4) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(arc (pt 6.75, 9.122) (radius 1.482) (startAngle 120.4) (sweepAngle -60.8) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 7.5 10.4) (pt 11.925 3.9) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 11.925 3.9) (pt 11.925 -3.9) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 11.925 -3.9) (pt 3.785 -10.4) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 3.785 -10.4) (pt -3.785 -10.4) (width 0.025))
		)
		(layerContents (layerNumRef 18)
	...
	(compDef "3025" (originalName "3025") (compHeader (numPins 3) (numParts 1) (refDesPrefix U)
		...
		(attr "<Hyperlink>" "https://www.keyelco.com/product-pdf.cfm?p=740")
		(attr "<Component Height>" "7.75")
		(attr "<STEP Filename>" "3025.stp")
		(attr "<STEP Offsets>" "X=-0.92;Y=2.54;Z=5.3")
