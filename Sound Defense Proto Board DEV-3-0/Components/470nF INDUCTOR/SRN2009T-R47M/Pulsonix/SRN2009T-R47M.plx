...
(library Library_1
	...
	(patternDef "INDC2016X95N" (originalName "INDC2016X95N")
		...
		(layerContents (layerNumRef 28)
			(line (pt -1.025 0.825) (pt 1.025 0.825) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 1.025 0.825) (pt 1.025 -0.825) (width 0.025))
		)
	...
	(compDef "SRN2009T-R47M" (originalName "SRN2009T-R47M") (compHeader (numPins 2) (numParts 1) (refDesPrefix L)
		...
		(attr "<Hyperlink>" "https://componentsearchengine.com/Datasheets/1/SRN2009T-R47M.pdf")
		(attr "<Component Height>" "0.95")
		(attr "<STEP Filename>" "SRN2009T-R47M.stp")
