...
//16154742/1476731/2.50/2/3/Resistor
...
(library Library_1
	...
	(symbolDef "RC0402JR-0710KL" (originalName "RC0402JR-0710KL")
	...
	(compDef "RC0402JR-0710KL" (originalName "RC0402JR-0710KL") (compHeader (numPins 2) (numParts 1) (refDesPrefix R)
		)
		(compPin "1" (pinName "1") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "2") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "RC0402JR-0710KL"))
		...
		(attr "Manufacturer_Part_Number" "RC0402JR-0710KL")
		(attr "Mouser Part Number" "603-RC0402JR-0710KL")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/YAGEO/RC0402JR-0710KL?qs=V1yeUXFNrkk4BhFptVo0Rw%3D%3D")
		(attr "Arrow Part Number" "RC0402JR-0710KL")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/rc0402jr-0710kl/yageo?region=nac")
		(attr "Description" "Yageo 10k, 0402 (1005M) Thick Film SMD Resistor +/-5% 0.0625W - RC0402JR-0710KL")
		...
		(attr "<STEP Filename>" "RC0402JR-0710KL.stp")
